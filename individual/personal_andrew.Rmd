...
```{r How has weather fatalities changed over time?}
...
combine_hist <- filter(na.omit(combine_fatality), weather_cat == "Fire/HiTemps" & year(ymd) >= "1998" & year(ymd) <= "2003") %>%
  ggplot(aes(x=year(ymd))) +
  geom_histogram(binwidth = 1) +
  labs(y="Amount of fatalities",x="Years",title="Fire and High Temperature Fatalities Between 1998 and 2003") +
