...
# Exact values for 2013-4
details_grouped_2013_4 %>%
  select(event_type, fatality_group, damage_group, avg_fatalities_by_type, avg_damage_by_type) %>%
  arrange(fatality_group, damage_group)

# Convert and display all rows
as.data.frame(details_grouped)
as.data.frame(details_grouped_1996_7)
as.data.frame(details_grouped_2013_4)
